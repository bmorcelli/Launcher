...
static const uint8_t CW2017_BATINFO[80] = {
    0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xaa, 0xbf, 0xb5, 0xb4, 0xa4, 0x9c,
    0xeb, 0xe2, 0xdf, 0xe5, 0xca, 0xa0, 0x8a, 0x62, 0x53, 0x48, 0x40, 0x3a, 0x32, 0xb1,
    0xae, 0xda, 0xb5, 0xff, 0xff, 0xff, 0xe8, 0xdb, 0xd9, 0xd6, 0xd4, 0xd2, 0xd0, 0xcb,
    0xc3, 0xbc, 0x9e, 0x87, 0x7b, 0x71, 0x72, 0x7c, 0x8c, 0xa3, 0xb7, 0xc8, 0xa5, 0x4f,
    0x00, 0x00, 0xab, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00,
...
static void cw2017EnsureProfile() {
    ...
    if (i2cReadReg8(CW2017_ADDR, CW2017_REG_CONFIG, cfg) && (cfg & 0x80)) {
        ...
        for (uint8_t i = 0; i < sizeof(CW2017_BATINFO); ++i) {
            uint8_t b = 0;
            if (!i2cReadReg8(CW2017_ADDR, (uint8_t)(CW2017_REG_BATINFO + i), b) ||
                b != CW2017_BATINFO[i]) {
                match = false;
                break;
            }
