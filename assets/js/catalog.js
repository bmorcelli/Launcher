...
const flashFirmwareParts = async (port, parts, expectedChipFamily, eraseFirst, onState) => {
...
const openCatalogFlashDialog = (parts, expectedChipFamily, firmwareName, isApp = false) => {
